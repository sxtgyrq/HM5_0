                    ...
                    };
                    {
                        foreach (var item in group._PlayerInGroup)
                        {
                            v3.Datas.Add(new ResistanceDisplay_V3.Item()
                            {
                                ...
                                isFinished = group.taskFineshedTime.ContainsKey(item.Key),
                                ...
                                SelectRightPercent = item.Value.SelectCount == 0 ? 0 : (item.Value.SelectWrongCount * 1000 / item.Value.SelectCount),
