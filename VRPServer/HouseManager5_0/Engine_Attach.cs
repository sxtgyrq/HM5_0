...
namespace HouseManager5_0
{
    public class Engine_Attach : Engine, interfaceOfEngine.engine, interfaceOfEngine.tryCatchAction
    {
        ...
        public RoomMain.commandWithTime.ReturningOjb maindDo(Player player, Car car, Command c, GetRandomPos grp, ref List<string> notifyMsg, out RoomMain.MileResultReason mrr)
        {
            ...
            //    else
            //    {
            //        if (that._Players[dm.To].playerType == Player.PlayerType.player)
            //        {
            //            var boss = (Player)that._Players[dm.To];
            ...
            //            }
            //        }
            //        else if (that._Players[dm.To].playerType == Player.PlayerType.NPC)
            //        {
