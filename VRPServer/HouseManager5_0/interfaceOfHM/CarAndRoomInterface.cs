...
namespace HouseManager5_0.interfaceOfHM
{
    ...
    {
        void SetAnimateChanged(HouseManager5_0.Player player, HouseManager5_0.Car car, ref List<string> notifyMsg);
        ...
        void DriverSelected(HouseManager5_0.Player player, HouseManager5_0.Car car, ref List<string> notifyMsgs);
    }
}
