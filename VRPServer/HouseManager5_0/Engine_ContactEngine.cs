...
namespace HouseManager5_0
{
    public abstract class Engine_ContactEngine : Engine
    {
        ...
        private RoomMainF.RoomMain.commandWithTime.ReturningOjb contactPassBossAddress(Player player, Player boss, Car car, interfaceOfHM.ContactInterface ci, GetRandomPos grp, ref List<string> notifyMsg, out MileResultReason mrr)
        {
            throw new Exception();
        ...
        private void DealWithDirectAttack(ref Car car, ref Player player, ref Player victimOrBeneficiary, GetRandomPos grp)
        {
            if (car.DirectAttack)
            {
        ...
        public commandWithTime.ReturningOjb randomWhenConfused(Player player, Player boss, Car car, interfaceOfHM.ContactInterface ci, GetRandomPos grp, ref List<string> notifyMsg, out MileResultReason Mrr)
        {
            throw new Exception("");
        ...
        public RoomMainF.RoomMain.commandWithTime.ReturningOjb contact(Player player, Car car, interfaceOfHM.ContactInterface ci, GetRandomPos grp, ref List<string> notifyMsg, out MileResultReason Mrr)
        {
            throw new Exception();
