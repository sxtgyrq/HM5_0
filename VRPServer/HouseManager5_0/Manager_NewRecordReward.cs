                   ...
                   BitCoin.CheckAddress.CheckAddressIsUseful(addrTo)
                   )
                    {
                        ...
                        if (indexNumber >= 0)
                        {
                            ...
                            var agreement = $"{indexNumber}@{addrFrom}@{addrBussiness}->{addrTo}:{ri.SatoshiCount}satoshi";
                            string notifyMsg;
                            ...
                            if (success)
                            {
                                switch (player.Group.groupNumber)
                                {
                                    case 1:
                                        {
                                            this.WebNotify(player, $"你刷新的单人任务的记录，你在{ri.BaseAddrName}处获得了{ri.SatoshiCount}satoshi的股份！");
                                        }; break;
                                    case 2:
                                        {
                                            this.WebNotify(player, $"你刷新的双人任务的记录，你在{ri.BaseAddrName}处获得了{ri.SatoshiCount}satoshi的股份！");
                                        }; break;
                                    case 3:
                                        {
                                            this.WebNotify(player, $"你刷新的三人任务的记录，你在{ri.BaseAddrName}处获得了{ri.SatoshiCount}satoshi的股份！");
                                        }; break;
                                    case 4:
                                        {
                                            this.WebNotify(player, $"你刷新的四人任务的记录，你在{ri.BaseAddrName}处获得了{ri.SatoshiCount}satoshi的股份！");
                                        }; break;
                                    case 5:
                                        {
                                            this.WebNotify(player, $"你刷新的五人任务的记录，你在{ri.BaseAddrName}处获得了{ri.SatoshiCount}satoshi的股份！");
                                        }; break;
                                }
                            }
                        }
