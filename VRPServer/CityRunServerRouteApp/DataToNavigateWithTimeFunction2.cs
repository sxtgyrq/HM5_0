...
//                            if (CityRunFunction.FormatLike.LikeFsPresentCode(key))
//                            {
//                                if (A.Count == 0)
//                                {
...
//                            }
//                            else if (CityRunFunction.FormatLike.LikeCross(key))
//                            {
//                                if (A.Count == 0)
//                                {
//                                    throw new Exception("");
...
//                            if (CityRunFunction.FormatLike.LikeFsPresentCode(fpLast.FastenPositionID))
//                            {
//                                if (A.Count == 0)
//                                {
//                                    var passedFp = fpLast;
...
//                            if (CityRunFunction.FormatLike.LikeFsPresentCode(fpLast.FastenPositionID) || fpLast.FastenPositionID == virtualFastonPositionID)
//                            {
//                                if (A.Count == 0)
//                                {
//                                    var passedFp = fpLast;
...
//            else
//            {
//                if (CityRunFunction.FormatLike.LikeFsPresentCode(key) || key == virtualFastonPositionID)
//                {
...
//                    var l = CityRunFunction.Geography.getLengthOfTwoPoint.GetDistance(lat1, lon1, lat2, lon2);
