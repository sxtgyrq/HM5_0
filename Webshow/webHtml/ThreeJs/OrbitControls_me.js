...
THREE.OrbitControls = function (object, domElement) {
    ...
    function onTouchStart(event) {
        ...
        if (window.touchEndEventSelfRegester != undefined) {
            window.touchEndEventSelfRegester(event);
        }
        if (scope.enabled === false) return;
    ...
    // scope.domElement.addEventListener('click', function (event) { alert('点击'); }, false);
